...
for unrolls in range(5):
	for copy in range(30):
	    ...
	    # Create file
		f  = open(new_dir + '/'+ 'sub_wrong-copies' + str(copy) + '-unrolls' + str(unrolls) + '.c','w+')
		sys.stdout = f
		...
		if random.randint(0,1) == 0:
			print(init_string.format(var_i, var_i, random.randint(0,10000))) 
		else:
			print(init_string_inline.format(var_i, random.randint(0,10000))) 
