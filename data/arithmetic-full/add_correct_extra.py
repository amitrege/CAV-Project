...
for copy in range(30):
	# Create file
	f  = open(new_dir + '/'+ 'add_correct-copies' + str(copy) + '-unrolls' + str(unrolls) + '.c','w+')
	sys.stdout = f
	...
	for i in range(unrolls):
		...
		if random.randint(0,1) == 0:
			print(add_indent(i+1, add_string.format(var_i, var_i, var_i)))
		else:
			print(add_indent(i+1, add_alt.format(var_i, var_i)))
	...
	if random.randint(0,1) == 0:
		print(add_indent(unrolls+1, add_string.format(var_i, var_i, var_i)))
	else:
		print(add_indent(unrolls+1, add_alt.format(var_i, var_i)))
	if random.randint(0,1) == 0:
