...
fp = code_gen.get_file_paths('fact1')
code_gen.concat_files(fp, 'fact1.txt')

fp = code_gen.get_file_paths('fact2')
code_gen.concat_files(fp, 'fact2.txt')
...
data_list, labels_list = init_data('fact1', data_list, labels_list, 1)
data_list, labels_list = init_data('fact2', data_list, labels_list, 0)
