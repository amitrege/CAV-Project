...
for unrolls in range(2):
	for copy in range(20000):
	
		# Create file
		f  = open(new_dir + '/'+ 'fact1-copies' + str(copy) + '-unrolls' + str(unrolls) + '.c','w+')
		sys.stdout = f
		...
		if random.randint(0,1) == 0:
			print(init_string.format(var_i, var_i, 1)) 
		else:
			print(init_string_inline.format(var_i, 1)) 
